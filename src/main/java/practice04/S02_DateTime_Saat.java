...
public class S02_DateTime_Saat {
    ...
    */
    public static void main(String[] args) {
        ...
        LocalTime entryTime = LocalTime.of(saat, dakika);
        LocalTime ilerikiSaat = entryTime.plusHours(1).plusMinutes(30);
        System.out.println(ilerikiSaat);

        int yeniSaat = ilerikiSaat.getHour();
        int yeniDakika = ilerikiSaat.getMinute();
        System.out.println("1 saat 30 dk sonra saat: " + yeniSaat + ":" + yeniDakika + " olacaktir.");
    }
}
